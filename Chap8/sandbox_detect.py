...
def detect_sandbox():
    ...
    max_moust_clicks = random.randint(5, 25)
    ...
    while not detection_complete:
        ...
        if keypress_time is not None and previous_timestamp is not None:
            ...
            # enough user input
            if keystrokes >= max_keystrokes and double_clicks >= max_double_clicks and mouse_clicks >= max_moust_clicks:
                return
